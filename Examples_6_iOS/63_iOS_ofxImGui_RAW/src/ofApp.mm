...
void ofApp::draw(){
    ...
    bool pressed = ImGui::ImageButton("a", (ImTextureID)(uintptr_t)imageButtonID, ImVec2(200, 200));
    pressed = ImGui::ImageButton("b", (ImTextureID)(uintptr_t)pixelsButtonID, ImVec2(200, 200));
    pressed = ImGui::ImageButton("c", (ImTextureID)(uintptr_t)textureSourceID, ImVec2(200, 200));

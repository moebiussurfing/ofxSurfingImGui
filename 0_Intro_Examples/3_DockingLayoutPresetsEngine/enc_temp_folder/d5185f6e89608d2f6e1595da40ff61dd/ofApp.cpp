...
void ofApp::drawImGui()
{
	...
	if (guiManager.getWindowSpecialVisible(0))
	{
	...
	if (guiManager.getWindowSpecialVisible(2))
	{
	...
	if (guiManager.getWindowSpecialVisible(3))
	{
	...
	if (guiManager.getWindowSpecialVisible(4))
	{

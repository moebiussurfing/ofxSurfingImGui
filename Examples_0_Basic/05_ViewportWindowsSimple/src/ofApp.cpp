...
void ofApp::setup() {
	...
	//ui.setName("ofApp"); // Optional: Recommended to set a name when using multiple instances of the Gui Manager!

	ui.setImGuiViewPort(true); // -> Enable viewport mode aka allow moving imgui windows/panels out of the app window
	// Must call before ui.setup()!
	
	//ui.setup(); // Optional: its auto called internally

...
/*
	...
	- Enable viewport mode aka allow moving imgui windows/panels out of the app window:
		ui.setImGuiViewPort(true);
	Recommended to check the example: \addons\ofxImGui\example-dockingandviewports
	
	- Enable simple docking auto managemnent:

...
namespace ofxImGuiSurfing
{
	...
	//--------------------------------------------------------------
	inline bool drawStylesSelector(const char* label)
	{
		...
		if (b1 || b2)
		{
			...
			case 12: ofxImGuiSurfing::Theme_Blender(); break;
			case 13: ofxImGuiSurfing::Theme_Cyberpunk(); break;
			case 14: ofxImGuiSurfing::Theme_Nord(); break;
			}
			return true;
		}
		return false;
	...
	inline void drawThemeSelector(ImGuiStyle* ref)
	{
		...
		if (ofxImGuiSurfing::drawStylesSelector("Colors##Selector")) ref_saved_style = style;

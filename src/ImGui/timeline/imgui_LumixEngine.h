...
//
//
//	//inline bool ToolbarButton(ImTextureID texture, const ImVec4& bg_color, const char* tooltip)
//	//{
...
//
//
//	//inline bool BeginToolbar(const char* str_id, ImVec2 screen_pos, ImVec2 size)
//	//{
...
//
//
//	//inline void HSplitter2(const char* str_id, ImVec2* size)
//	//{
...
//
//
//	inline bool BeginTimeline(const char* str_id, float max_value)
//	{
...
//
//
//	inline bool TimelineEvent(const char* str_id, float* values)
//	{
//		ImGuiWindow* win = GetCurrentWindow();
...
//		const ImU32 line_color = ColorConvertFloat4ToU32(GImGui->Style.Colors[ImGuiCol_PlotHistogram]);

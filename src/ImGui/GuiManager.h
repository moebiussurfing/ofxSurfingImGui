...
public:
    ...
    //--------------------------------------------------------------
    void AddLabelLinkURL(std::string label, std::string url, SurfingFontTypes fontType = OFX_IM_FONT_DEFAULT,
                         bool bBlink = true)
    {
        switch (fontType)
        {
...
public:
    ...
    //--------------------------------------------------------------
    bool BeginTree(std::string label, bool open /*= false*/, bool bIndented = true,

...
public:
    ...
    */
    ...
    //--------------------------------------------------------------
    void AddSeparatorText(const std::string label, int index = 0)
    {
        pushStyleFont(index);
    ...
    void AddSeparatorText(std::string label, int index, bool bUppercase, bool bSpacing)
    {
        if (bUppercase) label = ofToUpper(label);

        AddSeparatorText(label, index);

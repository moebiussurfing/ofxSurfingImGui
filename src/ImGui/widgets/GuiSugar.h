...
ImVec2 size_max = ImVec2(600, IMGUI_SUGAR__WINDOW_FIT_APP_HEIGHT); \
ImGui::SetNextWindowSizeConstraints(size_min, size_max); \
}
#define IMGUI_SUGAR__WINDOWS_CONSTRAINTSW_MEDIUM \
{ \
ImVec2 size_min = ImVec2(300, -1); \
ImVec2 size_max = ImVec2(500, IMGUI_SUGAR__WINDOW_FIT_APP_HEIGHT); \
ImGui::SetNextWindowSizeConstraints(size_min, size_max); \
}
#define IMGUI_SUGAR__WINDOWS_CONSTRAINTSW \
{ \
ImVec2 size_min = ImVec2(210, 1); \
ImVec2 size_max = ImVec2(300, IMGUI_SUGAR__WINDOW_FIT_APP_HEIGHT); \
ImGui::SetNextWindowSizeConstraints(size_min, size_max); \
}
#define IMGUI_SUGAR__WINDOWS_CONSTRAINTSW_SMALL \
{ \
ImVec2 size_min = ImVec2(150, -1); \
ImVec2 size_max = ImVec2(200, IMGUI_SUGAR__WINDOW_FIT_APP_HEIGHT); \
ImGui::SetNextWindowSizeConstraints(size_min, size_max); \
}
#define IMGUI_SUGAR__WINDOWS_CONSTRAINTSW_MINI \
{ \
ImVec2 size_min = ImVec2(100, -1); \
ImVec2 size_max = ImVec2(150, IMGUI_SUGAR__WINDOW_FIT_APP_HEIGHT); \
ImGui::SetNextWindowSizeConstraints(size_min, size_max); \
}
};

...
{
	bool AddKnobStyled(ofParameter<float>& parameter, ImGuiKnobType type = OFX_IMGUI_KNOB_TICKKNOB, float size = 0, string format = "%.1f", ImGuiKnobFlags flags = 0, float speed = 0.1f);

...
# Clean bin/data
# echo "Clean /bin/data. Remove all except '/bin/data/assets/' and '/bin/data/assets/fonts/'"
# cd "$folder_path/bin/data/"
# if ! find . -path "./assets" -prune -o -path "./assets/fonts" -prune -o -type f -print -delete ; then

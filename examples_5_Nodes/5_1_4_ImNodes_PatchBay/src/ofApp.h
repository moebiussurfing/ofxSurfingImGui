...
public:
	...
	void show()
	{
		...
		ImGui::TextUnformatted("B -- add node");
		...
		ImNodes::BeginNodeEditor();
		{
			...
			for (Node& node : nodes_)
			{
				...
				//ImNodes::BeginInputAttribute(node.id << 8 * ++i);
				//ImGui::TextUnformatted("input 3");
				//ImNodes::EndInputAttribute();

				//ImNodes::BeginInputAttribute(node.id << 8 * ++i);
				//ImGui::TextUnformatted("input 4");
				//ImNodes::EndInputAttribute();
				...
				const float text_width = ImGui::CalcTextSize("output 1").x;
				...
				//ImNodes::BeginOutputAttribute(node.id << 8 * ++i);
				//ImGui::Indent(120.f - text_width);
				//ImGui::TextUnformatted("output 3");
				//ImNodes::EndOutputAttribute();

				//ImNodes::BeginOutputAttribute(node.id << 8 * ++i);
				//ImGui::Indent(120.f - text_width);
				//ImGui::TextUnformatted("output 4");
				//ImNodes::EndOutputAttribute();
			...
			//	ImNodes::EndNodeTitleBar();
			//	
			//	//const float text_width = ImGui::CalcTextSize("input _").x;
			//	//ImGui::Indent(120.f - text_width);

			//	ImNodes::BeginInputAttribute(node.id << 1 * ++i);
			//	ImGui::TextUnformatted("input 1");
			//	ImNodes::EndInputAttribute();
